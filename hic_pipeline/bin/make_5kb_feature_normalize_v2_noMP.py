...
if __name__ == '__main__':
	...
	outbamfile = [input_bam.split('.')[0], targetchr, 'bam']
	outbamfilepath = '{}/{}'.format(output_dir, '.'.join(outbamfile))

	cis_feature_path1  = '{}/{}.{}.cis.40kbfeature.gz'.format(output_dir, samplename, targetchr)		
	cis_feature_path2 = '{}/{}.{}.cis.5kbfeature.gz'.format(output_dir, samplename, targetchr)		
	make_Feature(outbamfilepath, coverage_40kbdict, cov5kbfile, cis_feature_path1, cis_feature_path2, targetchr)

	cis_normalize(cis_feature_path1, cis_feature_path2, normalize_script_path1, normalize_script_path2)
