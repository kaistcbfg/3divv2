...
if __name__ == '__main__':
	...
	cis_feature_path = '{}/{}.{}.cis.feature.gz'.format(output_dir, samplename, targetchr)		
	trans_feature_path = '{}/{}.{}.trans.feature.gz'.format(output_dir, samplename, targetchr)
	make_Feature(chrbampath, coverage_dict, resolution, cis_feature_path, trans_feature_path, chrname)

	cis_normalize(cisfeature, normalize_script_path)
#
